         ...
         card.innerHTML = `
           ...
           <figure class="h-[200px]">
            ...
            <div class="flex space-x-4 mx-5 mt-2 mb-2">
                 <button onclick="loadImg(${pet.petId})" class="border border-slate-500 rounded-md w-[56px] h-[38px] text-[#0E7A81] font-bold text-lg"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
